...
public static partial class AgcExports
{
        ...
        out ulong indirectDimsRetryAddress)
    {
        ...
        {
            // Absolute indirect dispatches commonly point at one argument block
            // generated by earlier GPU work, so allow a bounded retry while that
            // producer completes. Base-relative dispatches commonly walk tables
            // containing many intentionally empty entries; retrying every zero
            // entry serially added seconds of startup stalls in Demon's Souls.

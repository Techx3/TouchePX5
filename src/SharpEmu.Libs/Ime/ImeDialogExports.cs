...
public static class ImeDialogExports
{
    ...
    private const string DefaultInputText = "Touche";
    ...
    private static void TryWriteInputText(CpuContext ctx, ulong parameterAddress)
    {
        ...
        var text = Environment.GetEnvironmentVariable("TOUCHEPX5_DEFAULT_PROFILE");
        if (string.IsNullOrEmpty(text))
        {
            text = Environment.GetEnvironmentVariable("SHARPEMU_DEFAULT_PROFILE");
        }

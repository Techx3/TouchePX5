...
internal static partial class Program
{
    ...
    {
        Log.Info("Usage: TouchePx5 [--strict] [--trace-imports[=N]] [--cpu-engine=<native>] [--fps-limit=<0-240>] [--log-level=<level>] [--log-file[=<path>]] [--debug-server[=host:port]] [--firmware-lle --firmware-store=<path> --firmware-profile=<id>] <path-to-eboot.bin>");
